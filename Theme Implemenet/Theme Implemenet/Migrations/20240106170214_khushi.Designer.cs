...
namespace Theme_Implemenet.Migrations
{
    ...
    [Migration("20240106170214_khushi")]
    partial class khushi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.ApplicationRole", b =>
                {
                    ...
                    b.Property<string>("CreateRoleId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CreateRoleId");

                    b.HasDiscriminator().HasValue("ApplicationRole");
                });

            modelBuilder.Entity("Theme_Implemenet.Models.CreateRole", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityRole");

                    b.Property<int>("CompanyId")
                        .HasColumnType("int")
                        .HasColumnName("CreateRole_CompanyId");

                    b.Property<DateTime>("CreateDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("CreateRole_CreateDate");

                    b.Property<DateTime>("Lastmodifield")
                        .HasColumnType("datetime2")
                        .HasColumnName("CreateRole_Lastmodifield");
                    ...
                    b.Property<int>("StatusId")
                        .HasColumnType("int")
                        .HasColumnName("CreateRole_StatusId");

                    b.HasIndex("CompanyId");

                    b.HasIndex("StatusId");

                    b.HasDiscriminator().HasValue("CreateRole");
                });
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Modulepagespermissions", b =>
                {
                    ...
                    b.HasOne("Theme_Implemenet.Models.CreateRole", "CreateRole")
                        .WithMany("role")
                        .HasForeignKey("RoleId");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.userproductpermission", b =>
                {
                    b.HasOne("Theme_Implemenet.Models.Register", "Register")
                        .WithMany("userproductpermission")
                        .HasForeignKey("Id");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasOne("Theme_Implemenet.Models.CreateRole", null)
                        .WithMany("Roles")
                        .HasForeignKey("CreateRoleId");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Register", b =>
                {
                    b.Navigation("userproductpermission");
                });
